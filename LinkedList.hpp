...
public:
    ...
    // Data operations
    void insert(std::string id, int age, std::string mode,
    ...
    void bubbleSortByMode(std::chrono::duration<double>& time);
    ...
    void linearSearchFirstByAge(AgeGroup group, std::chrono::duration<double>& time);
    ...
    void linearSearchFirstByMode(const std::string& mode, std::chrono::duration<double>& time);
    ...
    void linearSearchFirstByDistance(double threshold, std::chrono::duration<double>& time);
